    ...
    if len(data.split()) < 2:
        mm = [
            InlineQueryResultArticle(
                ...
                thumb_url="https://telegra.ph/file/5e9411544c475f8b1c89b.jpg",
...
async def in_help():
    answers = [
        InlineQueryResultArticle(
            title="💒 Whisper",
            description=f"@RIYA_MUSICZX_BOT [USERNAME | ID] [TEXT]",
            input_message_content=InputTextMessageContent(f"**📍Usage:**\n\n@RIYA_MUSICZX_BOT (Target Username or ID) (Your Message).\n\n**Example:**\n@YumikooBot @username I Wanna Phuck You"),
            thumb_url="https://telegra.ph/file/5e9411544c475f8b1c89b.jpg",
            reply_markup=switch_btn
        )
    ]
